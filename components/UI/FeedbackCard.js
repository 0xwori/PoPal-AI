...
function FeedbackCard({ type, content }) {
  ...
  switch (type) {
    case "Developer":
      typeDescription = "As a developer, I look at the techicalities within the User Story."
      break;
    case "Senior Product Manager":
      typeDescription = "As a product manager I look at overall User Story such as typos and how the business requirements are stated";
  ...
  return (
    <div class="w-full animate-fade-down mx-auto p-4 mt-5 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700">
      <div class="flow-root">
        ...
        <div class="flex flex-col leading-1.5 p-5 border-gray-200 bg-gray-100 rounded-xl dark:bg-gray-700" dangerouslySetInnerHTML={{ __html: parsedContent }}></div>
